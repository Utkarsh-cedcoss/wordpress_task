...
class Cryout_Notice {
	...
	function init() {
		...
		// set_theme_mod( 'reservoir_configured', FALSE ); // dev mode
	} // init()
	...
	function first_time_message() {
		...
		<div class="notice notice-info is-dismissible">
			...
			<p> <?php echo $this->strings[3]; ?>
				<a class="button" href="<?php echo esc_url( wp_nonce_url( $this->admin_url, 'disable_nag', '_reservoir_configured_nonce') ) ?>">
